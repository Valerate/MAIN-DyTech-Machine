...
require("prototypes.inserters.filter-inserter-entity")
require("prototypes.inserters.filter-inserter-item")
require("prototypes.inserters.filter-inserter-recipe")
