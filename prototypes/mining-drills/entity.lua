...
data.raw["mining-drill"]["electric-mining-drill"].icon = "__MAIN-DyTech-Machine__/graphics/mining-drills/basic-mining-drill1.png"
data.raw["mining-drill"]["electric-mining-drill"].max_health = Health.Tier3
data.raw["mining-drill"]["electric-mining-drill"].resistances = Resistances.Tier3 
data.raw["mining-drill"]["electric-mining-drill"].animations = Animation_Miner(Mk1)
data.raw["mining-drill"]["electric-mining-drill"].fast_replaceable_group =  "drill"
