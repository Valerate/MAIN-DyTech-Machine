data.raw["item"]["electric-mining-drill"].icon = "__MAIN-DyTech-Machine__/graphics/mining-drills/basic-mining-drill1.png"
...
{
  {
    ...
    subgroup = "dytech-machines-extractors",
    order = "a[miner]-2",
  ...
  },
  {
    ...
    subgroup = "dytech-machines-extractors",
    order = "a[miner]-3",
    place_result = "basic-mining-drill-mk3",
    stack_size = 50
  },
  {
    type = "item",
    ...
    subgroup = "dytech-machines-extractors",
    order = "a[miner]-4",
    place_result = "basic-mining-drill-mk4",
    stack_size = 50
  },
  {
    type = "item",
    ...
    subgroup = "dytech-machines-extractors",
    order = "a[miner]-5",
    place_result = "basic-mining-drill-mk5",
    stack_size = 50
  },
  {
    type = "item",
    ...
    subgroup = "dytech-machines-extractors",
    order = "a[miner]-6",
    place_result = "basic-mining-drill-mk6",
    stack_size = 50
  },
}
)